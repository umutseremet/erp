...
{
    public class GetMaintenanceByVehicleQueryHandler : IRequestHandler<GetMaintenanceByVehicleQuery, Result<IEnumerable<MaintenanceDto>>>
    {
        private readonly IUnitOfWork _unitOfWork;
        private readonly IMapper _mapper;

        public GetMaintenanceByVehicleQueryHandler(IUnitOfWork unitOfWork, IMapper mapper)
        {
